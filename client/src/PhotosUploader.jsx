...
export default function PhotosUploader({ addedPhotos, onChange }) {
  ...
  function selectAsMain(ev, filename) {
    ev.preventDefault();
    const newAddedPhotos = [filename, ...addedPhotos.filter(
  ...
  return (
    <>
      ...
      <div className="mt-2 grid gap-2 grid-cols-3 md:grid-cols-4 lggrid-cols-6">
        ...
        <label className="h-32 cursor-pointer flex items-center border bg-transparent rounded-2xl py-8 justify-center gap-2">
          <input
            type="file"
            multiple
            className="hidden"
